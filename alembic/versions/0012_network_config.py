...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "dhcp_range_start", sa.String(length=45), nullable=False, server_default="172.20.1.1"
        ),
        sa.Column(
            "dhcp_range_end", sa.String(length=45), nullable=False, server_default="172.20.254.254"
        ),
        sa.Column("dhcp_lease_hours", sa.Integer(), nullable=False, server_default="12"),
        sa.Column(
            "provisioning_base_url", sa.String(length=255), nullable=False, server_default=""
        ),
