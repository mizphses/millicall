...
詳細: [RUNBOOK-phase3-ai.md § 8](RUNBOOK-phase3-ai.md) / [RUNBOOK-phase6-auth.md § 7](RUNBOOK-phase6-auth.md)
...
```bash
curl -b cookie.txt -X POST http://127.0.0.1:8000/api/providers/<id>/test
```

詳細: [RUNBOOK-phase3-ai.md § 8](RUNBOOK-phase3-ai.md)
...
詳細: [RUNBOOK-phase6-auth.md § 4](RUNBOOK-phase6-auth.md)
...
詳細: [RUNBOOK-phase6-auth.md § 5](RUNBOOK-phase6-auth.md)
...
詳細: [RUNBOOK-phase5-netd.md § 5](RUNBOOK-phase5-netd.md)
...
詳細: [RUNBOOK-phase5-netd.md § 3、§ 5](RUNBOOK-phase5-netd.md)
...
詳細: [RUNBOOK-phase4a-mcp.md § 7](RUNBOOK-phase4a-mcp.md) / [MCP 利用](mcp.md)
